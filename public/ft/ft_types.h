...
typedef int_fast8_t			t_i8f;
typedef int_fast16_t		t_i16f;
typedef int_fast32_t		t_i32f;
typedef int_fast64_t		t_i64f;
typedef uint_fast8_t		t_u8f;
typedef uint_fast16_t		t_u16f;
typedef uint_fast32_t		t_u32f;
typedef uint_fast64_t		t_u64f;
typedef int_least8_t		t_i8l;
typedef int_least16_t		t_i16l;
typedef int_least32_t		t_i32l;
typedef int_least64_t		t_i64l;
typedef uint_least8_t		t_u8l;
typedef uint_least16_t		t_u16l;
typedef uint_least32_t		t_u32l;
typedef uint_least64_t		t_u64l;
