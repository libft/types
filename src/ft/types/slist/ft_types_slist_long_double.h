...
#ifndef FT_TYPES_SLIST_LONG_DOUBLE_H
# define FT_TYPES_SLIST_LONG_DOUBLE_H
...
{
	t_ft_types_slist_long_double_node	*head;
	t_ft_types_slist_long_double_node	*tail;
	size_t								length;
...
t_err	ft_types_slist_long_double_to_array(
			t_ft_types_slist_long_double *list,
			t_ft_types_array_long_double *out);
